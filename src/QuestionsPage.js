      ...
      return (
        <div>
            {this.props.options.questions && this.props.options.questions.length
              ? <QuestionCard nextQuestion={this.nextQuestion} data={this.props.options.questions[currentQuestion]}/>//this.renderQuestionCard(this.props.options.questions[currentQuestion])
              :
                <div>
                loading...
                </div>
